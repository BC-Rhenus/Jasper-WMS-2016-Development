...
#
billinginterfacedae.sh -m $HOME/xml/WMSInterfaceMapping.xml -s $ENV -p dcsdba/dcsabd -b $ENV -a dcsdba/dcsabd -u RCL-WMS -y RCL-WMS -1 -f -o $HOME/reports/tpb/billinginterfacedaemon.log -x "(trunc(ab_dtransaction.end_dstamp)<trunc(sysdate))" -L 3
